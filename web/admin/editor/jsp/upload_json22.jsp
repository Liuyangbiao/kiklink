...
//最大文件大小
long maxSize =(long)( ConfigUtils.getIntConfig("上传大小限制"))* 1024 * 1024;
...
/* 		if(!Arrays.<String>asList(fileTypes).contains(fileExt)){
		...
		try{
			newFileName = request.getParameter("shuzi") ;
			if (newFileName == null)
				newFileName = System.currentTimeMillis() + "." + fileExt;
			...
			//生成缩略图
			if ("bb".equalsIgnoreCase(fileExt)) {
				
			}
			else {
			FileUploadUtils.Thumbnail(savePath + newFileName, thumPath + newFileName, 100, 100, 100);
			}
...
%>
{"re":"1","str":"成功","fileName":"<% out.print(newFileName); %>"}