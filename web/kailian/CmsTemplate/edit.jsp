  ...
  <div id="main-content">
    ...
    <!-- 搜索 -->
      ...
      <div class="content-box-header">
        ...
        <h3>编辑<%=JSTLTagUtils.getCnname("CmsTemplate","table_name")%></h3>
      </div>
      <!-- End .content-box-header -->
      <div class="content-box-content">
        <div class="tab-content default-tab">
          	<form id="form1" action="${ctx}/kailian/CmsTemplate/update.do" method="post">
...
${my:input('CmsTemplate','path',model.path,0,0 )}			</p>	
...
${my:input('CmsTemplate','name',model.name,0,0 )}			</p>	
...
${my:input('CmsTemplate','content',model.content,0,0 )}			</p>	
...
${my:input('CmsTemplate','status',model.status,10,0 )}
			</p>	
...
${my:input('CmsTemplate','addition',model.addition,0,0 )}			</p>	
...
${my:input('CmsTemplate','createtimelong',model.createtimelong,10,0 )}
			</p>	
...
${my:input('CmsTemplate','modifytimelong',model.modifytimelong,10,0 )}
			</p>	
...
${my:input('CmsTemplate','createuser',model.createuser,10,0 )}
			</p>	
...
${my:input('CmsTemplate','modifyuser',model.modifyuser,10,0 )}
			</p>	
