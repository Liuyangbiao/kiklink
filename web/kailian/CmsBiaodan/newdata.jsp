    ...
    <!-- 搜索 -->
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab">
          	<form id="form1" action="${ctx}/kailian/CmsBiaodanDetail/savedetail.do" method="post">
		...
		<fieldset>
            ...
            <input type="hidden" id="biaodanid" name="biaodanid" value="${param.bid}"/>
            <input type="hidden" id="inputnames" name="inputnames" value="<c:forEach var="v" items="${list}" varStatus="vs">${v.inputEnName},</c:forEach>" />
			...
			<p id='title_p' class='p123'>
                 ...
                 ${my:input('CmsBiaodanDetail','title',model.title,0,0 )}	
		</p>	
			</c:if>
...
-->
            <c:forEach var="v" items="${list}" varStatus="vs">
            	<p id='${v.inputEnName}_p' class='p123'>
            		...
            		<c:choose>
                        ...
                        <c:when test="${v.inputType eq 11}">
                        	<input id="${v.inputEnName}" name="${v.inputEnName}" type="text" class="text-input medium-input" />
                            <script>
								doimg('${v.inputEnName}');
							</script>
                        </c:when>
