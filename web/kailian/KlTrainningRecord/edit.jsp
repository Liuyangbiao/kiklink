  ...
  <div id="main-content">
    ...
    <!-- 搜索 -->
      ...
      <div class="content-box-header">
        ...
        <h3>编辑<%=JSTLTagUtils.getCnname("KlTrainningRecord","table_name")%></h3>
      </div>
      <!-- End .content-box-header -->
      <div class="content-box-content">
        <div class="tab-content default-tab">
          	<form id="form1" action="${ctx}/kailian/KlTrainningRecord/update.do" method="post">
...
${my:input('KlTrainningRecord','userid',model.userid,10,0 )}
			</p>	
...
${my:input('KlTrainningRecord','username',model.username,0,0 )}			</p>	
...
${my:input('KlTrainningRecord','photo',model.photo,0,0 )}			</p>	
...
${my:input('KlTrainningRecord','content',model.content,0,0 )}			</p>	
...
${my:input('KlTrainningRecord','status',model.status,10,0 )}
			</p>	
...
${my:input('KlTrainningRecord','addition',model.addition,0,0 )}			</p>	
...
${my:input('KlTrainningRecord','createtimelong',model.createtimelong,10,0 )}
			</p>	
...
${my:input('KlTrainningRecord','modifytimelong',model.modifytimelong,10,0 )}
			</p>	
...
${my:input('KlTrainningRecord','createuser',model.createuser,10,0 )}
			</p>	
...
${my:input('KlTrainningRecord','modifyuser',model.modifyuser,10,0 )}
			</p>	
