  ...
  <div id="main-content">
    ...
    <!-- 搜索 -->
      ...
      <div class="content-box-header">
        ...
        <h3>编辑<%=JSTLTagUtils.getCnname("KlSellerCategory","table_name")%></h3>
      </div>
      <!-- End .content-box-header -->
      <div class="content-box-content">
        <div class="tab-content default-tab">
          	<form id="form1" action="${ctx}/kailian/KlSellerCategory/update.do" method="post">
		...
		<!-- ONGL access static field: @package.class@field or @vs@field -->
			...
			<p id='categoryName_p' class='p123'>
				 <label id='categoryName_mainlb'>
					<%=JSTLTagUtils.getCnname("KlSellerCategory",KlSellerCategory.ALIAS_CATEGORY_NAME)%>:
				 </label>
${my:input('KlSellerCategory','categoryName',model.categoryName,0,0 )}			</p>	
...
${my:input('KlSellerCategory','status',model.status,10,0 )}
			</p>	
...
${my:input('KlSellerCategory','addition',model.addition,0,0 )}			</p>	
...
${my:input('KlSellerCategory','createtimelong',model.createtimelong,10,0 )}
			</p>	
...
${my:input('KlSellerCategory','modifytimelong',model.modifytimelong,10,0 )}
			</p>	
...
${my:input('KlSellerCategory','createuser',model.createuser,10,0 )}
			</p>	
...
${my:input('KlSellerCategory','modifyuser',model.modifyuser,10,0 )}
			</p>	
