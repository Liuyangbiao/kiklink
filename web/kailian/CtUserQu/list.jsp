  ...
  <div id="main-content">
    ...
    <div class="content-box">
      ...
      <div class="content-box-header">
        <h3><%=JSTLTagUtils.getCnname("CtUserQu","table_name")%>列表
		&nbsp;&nbsp;
                ...
                <th>
                  <input class="check-all" type="checkbox" />
                	...
                	<c:if test="${tt ne ttid and tt ne ttcreator and tt ne ttdeleted and showmap[tt] ne null}">
						<th id="id_000"><span onclick="newsort('<%=CtUserQu.ALIAS_ID%>');"><%=JSTLTagUtils.getCnname("CtUserQu",CtUserQu.ALIAS_ID)%></span></th>
					</c:if>
                	...
                	<c:if test="${tt ne ttid and tt ne ttcreator and tt ne ttdeleted and showmap[tt] ne null}">
						<th id="cityid_000"><span onclick="newsort('<%=CtUserQu.ALIAS_CITYID%>');"><%=JSTLTagUtils.getCnname("CtUserQu",CtUserQu.ALIAS_CITYID)%></span></th>
					</c:if>
                	...
                	<c:if test="${tt ne ttid and tt ne ttcreator and tt ne ttdeleted and showmap[tt] ne null}">
						<th id="name_000"><span onclick="newsort('<%=CtUserQu.ALIAS_NAME%>');"><%=JSTLTagUtils.getCnname("CtUserQu",CtUserQu.ALIAS_NAME)%></span></th>
					</c:if>
                	...
                	<c:if test="${tt ne ttid and tt ne ttcreator and tt ne ttdeleted and showmap[tt] ne null}">
						<th id="firstchar_000"><span onclick="newsort('<%=CtUserQu.ALIAS_FIRSTCHAR%>');"><%=JSTLTagUtils.getCnname("CtUserQu",CtUserQu.ALIAS_FIRSTCHAR)%></span></th>
					</c:if>
                	...
                	<c:if test="${tt ne ttid and tt ne ttcreator and tt ne ttdeleted and showmap[tt] ne null}">
						<th id="imghead_000"><span onclick="newsort('<%=CtUserQu.ALIAS_IMGHEAD%>');"><%=JSTLTagUtils.getCnname("CtUserQu",CtUserQu.ALIAS_IMGHEAD)%></span></th>
					</c:if>
                	...
                	<c:if test="${tt ne ttid and tt ne ttcreator and tt ne ttdeleted and showmap[tt] ne null}">
						<th id="img1_000"><span onclick="newsort('<%=CtUserQu.ALIAS_IMG1%>');"><%=JSTLTagUtils.getCnname("CtUserQu",CtUserQu.ALIAS_IMG1)%></span></th>
					</c:if>
                	...
                	<c:if test="${tt ne ttid and tt ne ttcreator and tt ne ttdeleted and showmap[tt] ne null}">
						<th id="img2_000"><span onclick="newsort('<%=CtUserQu.ALIAS_IMG2%>');"><%=JSTLTagUtils.getCnname("CtUserQu",CtUserQu.ALIAS_IMG2)%></span></th>
					</c:if>
...
${my:showcont('CtUserQu','cityid',v.cityid,0 )}							</td>
					</c:if>
				
                	<c:set var="tt" value="NAME"></c:set>
                	<c:if test="${tt ne ttid and tt ne ttcreator and tt ne ttdeleted and showmap[tt] ne null}">
							<td id="name_${v.id}" class="td123 nameTd">
${my:showcont('CtUserQu','name',v.name,0 )}							</td>
					</c:if>
				
                	<c:set var="tt" value="FIRSTCHAR"></c:set>
                	<c:if test="${tt ne ttid and tt ne ttcreator and tt ne ttdeleted and showmap[tt] ne null}">
							<td id="firstchar_${v.id}" class="td123 firstcharTd">
${my:showcont('CtUserQu','firstchar',v.firstchar,0 )}							</td>
					</c:if>
				
                	<c:set var="tt" value="IMGHEAD"></c:set>
                	<c:if test="${tt ne ttid and tt ne ttcreator and tt ne ttdeleted and showmap[tt] ne null}">
							<td id="imghead_${v.id}" class="td123 imgheadTd">
${my:showcont('CtUserQu','imghead',v.imghead,0 )}							</td>
					</c:if>
				
                	<c:set var="tt" value="IMG1"></c:set>
                	<c:if test="${tt ne ttid and tt ne ttcreator and tt ne ttdeleted and showmap[tt] ne null}">
							<td id="img1_${v.id}" class="td123 img1Td">
${my:showcont('CtUserQu','img1',v.img1,0 )}							</td>
					</c:if>
				
                	<c:set var="tt" value="IMG2"></c:set>
                	<c:if test="${tt ne ttid and tt ne ttcreator and tt ne ttdeleted and showmap[tt] ne null}">
							<td id="img2_${v.id}" class="td123 img2Td">
${my:showcont('CtUserQu','img2',v.img2,0 )}							</td>
					</c:if>
...
${my:input('CtUserQu','list_iframe',v.id,-1,0 )}${my:input('CtUserQu','list_blank',v.id,-1,0 )}
        ...
        <div class="tab-content default-tab">
          <form id="queryForm" name="queryForm" action="${ctx}/${actionBasePath}/list.do" method="post" style="display: inline;">
			...
			<fieldset>
			 ...
			 <p id="id_formp">
              <label><%=JSTLTagUtils.getCnname("CtUserQu",CtUserQu.ALIAS_ID)%></label>
${my:input('CtUserQu','id',param.id,0,-1 )}						
						
              </p>
			
			 <p id="cityid_formp">
              <label><%=JSTLTagUtils.getCnname("CtUserQu",CtUserQu.ALIAS_CITYID)%></label>
${my:input('CtUserQu','cityid',param.cityid,0,-1 )}						
						
              </p>
			
			 <p id="name_formp">
              <label><%=JSTLTagUtils.getCnname("CtUserQu",CtUserQu.ALIAS_NAME)%></label>
${my:input('CtUserQu','name',param.name,0,-1 )}						
						
              </p>
			
			 <p id="firstchar_formp">
              <label><%=JSTLTagUtils.getCnname("CtUserQu",CtUserQu.ALIAS_FIRSTCHAR)%></label>
${my:input('CtUserQu','firstchar',param.firstchar,0,-1 )}						
						
              </p>
			
			 <p id="imghead_formp">
              <label><%=JSTLTagUtils.getCnname("CtUserQu",CtUserQu.ALIAS_IMGHEAD)%></label>
${my:input('CtUserQu','imghead',param.imghead,0,-1 )}						
						
              </p>
			
			 <p id="img1_formp">
              <label><%=JSTLTagUtils.getCnname("CtUserQu",CtUserQu.ALIAS_IMG1)%></label>
${my:input('CtUserQu','img1',param.img1,0,-1 )}						
						
              </p>
			
			 <p id="img2_formp">
              <label><%=JSTLTagUtils.getCnname("CtUserQu",CtUserQu.ALIAS_IMG2)%></label>
${my:input('CtUserQu','img2',param.img2,0,-1 )}						
