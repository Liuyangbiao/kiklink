  ...
  <div id="main-content">
    ...
    <!-- 搜索 -->
      ...
      <div class="content-box-header">
        ...
        <h3>编辑<%=JSTLTagUtils.getCnname("CmsStSpecialtopic","table_name")%></h3>
      </div>
      <!-- End .content-box-header -->
      <div class="content-box-content">
        <div class="tab-content default-tab">
          	<form id="form1" action="${ctx}/kailian/CmsStSpecialtopic/update.do" method="post">
		...
		<!-- ONGL access static field: @package.class@field or @vs@field -->
			...
			<p id='topicname_p' class='p123'>
				 <label id='topicname_mainlb'>
					<%=JSTLTagUtils.getCnname("CmsStSpecialtopic",CmsStSpecialtopic.ALIAS_TOPICNAME)%>:
				 </label>
${my:input('CmsStSpecialtopic','topicname',model.topicname,0,0 )}			</p>	
...
${my:input('CmsStSpecialtopic','keywords',model.keywords,0,0 )}			</p>	
...
${my:input('CmsStSpecialtopic','description',model.description,0,0 )}			</p>	
...
${my:input('CmsStSpecialtopic','bgimg1',model.bgimg1,0,0 )}			</p>	
			
		
			
			<p id='bgimg2_p' class='p123'>
				 <label id='bgimg2_mainlb'>
					<%=JSTLTagUtils.getCnname("CmsStSpecialtopic",CmsStSpecialtopic.ALIAS_BGIMG2)%>:
				 </label>
${my:input('CmsStSpecialtopic','bgimg2',model.bgimg2,0,0 )}			</p>	
			
		
			
			<p id='suggestwords_p' class='p123'>
				 <label id='suggestwords_mainlb'>
					<%=JSTLTagUtils.getCnname("CmsStSpecialtopic",CmsStSpecialtopic.ALIAS_SUGGESTWORDS)%>:
				 </label>
${my:input('CmsStSpecialtopic','suggestwords',model.suggestwords,0,0 )}			</p>	
			
		
			
			<p id='headimg_p' class='p123'>
				 <label id='headimg_mainlb'>
					<%=JSTLTagUtils.getCnname("CmsStSpecialtopic",CmsStSpecialtopic.ALIAS_HEADIMG)%>:
				 </label>
${my:input('CmsStSpecialtopic','headimg',model.headimg,0,0 )}			</p>	
			
		
			
			<p id='topictype_p' class='p123'>
				 <label id='topictype_mainlb'>
					<%=JSTLTagUtils.getCnname("CmsStSpecialtopic",CmsStSpecialtopic.ALIAS_TOPICTYPE)%>:
				 </label>
${my:input('CmsStSpecialtopic','topictype',model.topictype,10,0 )}
			</p>	
...
${my:input('CmsStSpecialtopic','templateid',model.templateid,10,0 )}
			</p>	
...
${my:input('CmsStSpecialtopic','rank',model.rank,10,0 )}
			</p>	
...
${my:input('CmsStSpecialtopic','styleclass',model.styleclass,0,0 )}			</p>	
...
${my:input('CmsStSpecialtopic','ext1',model.ext1,0,0 )}			</p>	
...
${my:input('CmsStSpecialtopic','ext2',model.ext2,0,0 )}			</p>	
...
${my:input('CmsStSpecialtopic','ext3',model.ext3,0,0 )}			</p>	
...
${my:input('CmsStSpecialtopic','ext4',model.ext4,0,0 )}			</p>	
...
${my:input('CmsStSpecialtopic','ext5',model.ext5,0,0 )}			</p>	
...
${my:input('CmsStSpecialtopic','extInt1',model.extInt1,10,0 )}
			</p>	
...
${my:input('CmsStSpecialtopic','extInt2',model.extInt2,10,0 )}
			</p>	
...
${my:input('CmsStSpecialtopic','extInt3',model.extInt3,10,0 )}
			</p>	
...
${my:input('CmsStSpecialtopic','extInt4',model.extInt4,10,0 )}
			</p>	
...
${my:input('CmsStSpecialtopic','extInt5',model.extInt5,10,0 )}
			</p>	
			-->
...
${my:input('CmsStSpecialtopic','status',model.status,10,0 )}
			</p>	
...
${my:input('CmsStSpecialtopic','addition',model.addition,0,0 )}			</p>	
...
${my:input('CmsStSpecialtopic','createtimelong',model.createtimelong,10,0 )}
			</p>	
...
${my:input('CmsStSpecialtopic','modifytimelong',model.modifytimelong,10,0 )}
			</p>	
...
${my:input('CmsStSpecialtopic','createuser',model.createuser,10,0 )}
			</p>	
...
${my:input('CmsStSpecialtopic','modifyuser',model.modifyuser,10,0 )}
			</p>	
