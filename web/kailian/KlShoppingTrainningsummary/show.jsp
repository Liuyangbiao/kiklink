  ...
  <div id="main-contentx">
    ...
    <!-- 搜索 -->
      ...
      <div class="content-box-header">
        ...
        <h3>查看<%=JSTLTagUtils.getCnname("KlShoppingTrainningsummary","table_name")%></h3>
      </div>
