  ...
  <div id="main-content">
    ...
    <!-- 搜索 -->
      ...
      <div class="content-box-header">
        ...
        <h3>编辑<%=JSTLTagUtils.getCnname("KlShoppingShoppingcartproduct","table_name")%></h3>
      </div>
      <!-- End .content-box-header -->
      <div class="content-box-content">
        <div class="tab-content default-tab">
          	<form id="form1" action="${ctx}/kailian/KlShoppingShoppingcartproduct/update.do" method="post">
