  ...
  <div id="main-content">
    ...
    <!-- 搜索 -->
      ...
      <div class="content-box-header">
        ...
        <h3>编辑<%=JSTLTagUtils.getCnname("CtUserProvince","table_name")%></h3>
      </div>
      <!-- End .content-box-header -->
      <div class="content-box-content">
        <div class="tab-content default-tab">
          	<form id="form1" action="${ctx}/kailian/CtUserProvince/update.do" method="post">
...
${my:input('CtUserProvince','name',model.name,0,0 )}			</p>	
...
${my:input('CtUserProvince','firstchar',model.firstchar,0,0 )}			</p>	
...
${my:input('CtUserProvince','imghead',model.imghead,0,0 )}			</p>	
...
${my:input('CtUserProvince','img1',model.img1,0,0 )}			</p>	
...
${my:input('CtUserProvince','img2',model.img2,0,0 )}			</p>	
