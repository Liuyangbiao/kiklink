...
<nav class="navbar navbar-fixed-top">
      	...
      	<font id="usersname"></font>
            ...
            <a id="li_logout" style="" href="${ctx}/kailian/CmsUserInfo/logout.do">退出登录</a>
			...
			<div class="container head-wrap">
				...
				<div class="banner-slider-wrap">
					<ul id="banner-slider" class="bxslider">
						...
						<li>
							<a href="${my:jvalue(f.content, 'lianjie')}" target="_blank"><img src="${ctx}/${my:jvalue(f.content, 'tupianimg')}" style="width:1200px;height:380px;" /></a>
						</li>
						</c:forEach>
					...
					<div id="bx-pager">
						<c:forEach var="f" items="${map.focus}" varStatus="vs">	
							<a data-slide-index="${vs.index}" href="${my:jvalue(f.content, 'lianjie')}" target="_blank"><div class="mask"></div><img src="${ctx}/${my:jvalue(f.content, 'tupianimg')}" style="width:195px;height:62px;" /></a> 
