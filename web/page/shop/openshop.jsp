...
<title>个人开店申请${my:config('title后缀','--开练网')}</title>
...
<br/><b>第十五条</b><br/>	甲乙双方已仔细阅读《平台服务协议》的相关内容，对于各条款甲乙双方相互之间已进行充分的解释和沟通，双方同意遵守协议的相关约定，最终协议内容，以正式纸质协议方式确认。
      ...
      <div class="Personal">
      	<form id="form1" action="${ctx}/kailian/KlSellerShop/saveShop.do" method="post">
           ...
           <div class="list">
              <ul>
                <li><a href="#" class="aNow">个人开店</a></li>
                <li><a href="${ctx}/kailian/KlSellerShop/openShop.do?jigou=1&center=center" >机构开店</a></li>
              </ul>
           </div>
           <div class="form">
                ...
                <ul>
                  <li><em>店铺名称</em>
                      <span class="isRed">*</span><div class="input1"><input class="easyui-validatebox textbox" data-options="required:true" placeholder="店铺具体名称，如：XXX健身俱乐部（朝外大悦城店）" id="shopName" name="shopName" type="text" value="${map.shop.shopName}"/></div>
                  </li>
                  <li style="height:70px;"><em>店铺LOGO</em>
                      <div class="input1 input2"><input id="logo" name="logo" value="${map.shop.logo}" type="text"/></div>
                  ...
                  <li><em>真实姓名</em>
                      <span class="isRed">*</span><div  class="input1"><input class="easyui-validatebox textbox" data-options="required:true" plcaceholder="负责人姓名" id="realName" name="realName" value="${map.shop.realName}" type="text" /></div>
                  </li>
                  <li><em>身份证号码</em>
                      <span class="isRed">*</span><div class="input1"><input class="easyui-validatebox textbox" data-options="required:true" placeholder="负责人身份证号码" id="idNumber" name="idNumber" value="${map.shop.idNumber}" type="text" /></div>
                  </li>
                  <li><em>身份证正面</em>
                     <span class="isRed">*</span><div class="input1 input2"><input id="idPicture" class="easyui-validatebox textbox" data-options="required:true" placeholder="请提供身份证正面电子版图片" name="idPicture" value="${map.shop.idPicture}" type="text"/></div>
                      <input type="button" id="idPicture_button" class="btn1" value="浏 览…"/>
                      <input type="button" value="查看" class="btn1" onclick="showpic('idPicture');" />
                  </li>
                  <li><em>身份证反面</em>
                      <div class="input1 input2"><input id="idPcitureBack" name="idPcitureBack" value="${map.shop.idPcitureBack}" type="text"/></div>
                      <input type="button" id="idPcitureBack_button" class="btn1" value="浏 览…"/>
                      <input type="button" value="查看"  class="btn1" onclick="showpic('idPcitureBack');" />
                  </li>
                  <!--
                  ...
                  <li><em>年龄</em>
                      ...
                      <select id="birthYear" name="birthYear">
                      	<c:forEach var="v" begin="1900" end="2010">
                            <option value="${v}" <c:if test="${v eq 1980}"> selected = "selected"</c:if>>${v}</option>
                         </c:forEach>
                      </select>
                  ...
                  <li><em>性别</em>
                      <input id="sex" name="sex" value="1" class="" type="radio" <c:if test="${map.shop.sex eq null or param.sex eq 1}"> checked="true"</c:if> />男　
                      <input id="sex" name="sex" value="2" class="" type="radio" <c:if test="${map.shop.sex eq 2}"> checked="true"</c:if> />女
                  </li>
                  <li><em>电话</em>
                      <span class="isRed">*</span><div  class="input1"><input class="easyui-validatebox textbox" data-options="required:true" placeholder="座机号或手机号码" id="phoneno" name="phoneno" value="${map.shop.phoneno}" type="text" /></div>
                  </li>
                  <li><em>电子邮件</em>
                      <span class="isRed">*</span><div  class="input1"><input class="easyui-validatebox textbox" data-options="required:true" placeholder="负责人电子邮件" id="email" name="email" value="${map.shop.email}" type="text" /></div>
                  </li>
                  <li><em>通讯地址</em>
                      <span class="isRed">*</span><div  class="input1"><input class="easyui-validatebox textbox" data-options="required:true" placeholder="所在场地地址" id="address" name="address" value="${map.shop.address}" type="text" /></div>
                  </li>
                  <li><em>交通方式</em>
                  ...
                  <li class="li_01"><em>个人履历</em>
                      <textarea class="easyui-validatebox textbox" data-options="required:true" placeholder="个人相关背景说明，专业、奖项等相关介绍。" id="profile" name="profile" cols="" rows="">${map.shop.profile}</textarea><span class="isRed">*</span>
                  </li>
                  <li><em>开户银行及户名</em><span class="isRed">*</span>
                      <div class="input1 input3"><input class="easyui-validatebox textbox" data-options="required:true" placeholder="开户银行:请填写具体支行信息" id="bankname" name="bankname" value="${map.shop.bankname}" type="text" /></div>
                      <div class="input1 input3"><input class="easyui-validatebox textbox" data-options="required:true" placeholder="户名:请填写本人账号" id="bankopenname" name="bankopenname" value="${map.shop.bankopenname}" type="text" /></div>
                  </li>
                  <li><em>银行账户</em>
                      <span class="isRed">*</span><div class="input1"><input id="banknumber" class="easyui-validatebox textbox" data-options="required:true" placeholder="储蓄卡银行账号" name="banknumber" value="${map.shop.banknumber}" type="text" /></div>
...
$(document).ready(function(){
	...
	$("#sex").find("option[value='${map.shop.sex}']").attr("selected",true);
	$("#birthYear").find("option[value='${map.shop.birthYear}']").attr("selected",true);
	$("#birthMonth").find("option[value='${map.shop.birthMonth}']").attr("selected",true);
	$("#birthDate").find("option[value='${map.shop.birthDate}']").attr("selected",true);
	<c:choose>
...
KindEditor.ready(function(K) {
				...
				K('#idPicture_button').click(function() {
					editor.loadPlugin('image', function() {
						editor.plugin.imageDialog({
							showRemote : false,
							imageUrl : K('#idPicture').val(),
							clickFn : function(url, title, width, height, border, align) {
								K('#idPicture').val(url);
								editor.hideDialog();
							}
				...
				K('#idPcitureBack_button').click(function() {
					editor.loadPlugin('image', function() {
						editor.plugin.imageDialog({
							showRemote : false,
							imageUrl : K('#idPcitureBack').val(),
							clickFn : function(url, title, width, height, border, align) {
								K('#idPcitureBack').val(url);
								editor.hideDialog();
							}
						});
					});
