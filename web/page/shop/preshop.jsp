...
<title>我要开店${my:config('title后缀','--开练网')}</title>
...
<div class="fr w791">
      ...
      <!--pageBox-->
      <div class="myShop">
           <div class="imgDiv"><img src="${ctx}/image/nimg723.jpg"/></div>
           <h2>平台服务协议</h2>
           <div class="content">
...
<br/><b>第十五条</b><br/>	甲乙双方已仔细阅读《平台服务协议》的相关内容，对于各条款甲乙双方相互之间已进行充分的解释和沟通，双方同意遵守协议的相关约定，最终协议内容，以正式纸质协议方式确认。
         ...
         <div class="msg"><input id="agreed" name="agreed" type="checkbox" value="agreed" />同意协议内容</div>
         <div class="btnDiv"><input type="button" class="btn1" value="现在就申请" onclick="openshop();" /></div>
      </div>
      <!--pageBoxEnd-->
      </div>
</div>
...
<script>
	function openshop() {
		...
		//alert(agreed);
		if (agreed == 'checked') {
			window.location.href="${ctx}/kailian/KlSellerShop/openShop.do?center=center";
		}
		else {
			alert("您需要同意协议内容才能继续开店");
		}
	}
</script>
</body>
