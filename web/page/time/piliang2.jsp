...
<div class="fr w791">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tr>
           ...
           <th width="207"><a href="${ctx}/kailian/KlSellerProduct/classes.do?sort=id desc">周期</a></th>
           <th width="170"><a href="${ctx}/kailian/KlSellerProduct/classes.do?sort=classCount">时间</a></th>
...
<form id="formx" action="${ctx}/kailian/KlShoppingPiliangtime/piliang.do" method="post">
      ...
      <div class="form" style="height:auto;">
      		<input type="hidden" id="ext1" name="ext1" value="${param.preproductid}" />
      		<input type="hidden" id="preproductid" name="preproductid" value="${param.preproductid}" />
            <ul>
