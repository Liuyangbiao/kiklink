...
<div class="w993" style="width:791px;">
<!--wal-->
...
<div class="fr w791" >
              ...
              <tr>
                ...
                <c:choose>
                	<c:when test="${f.status gt 0}">
                		 <a href="${ctx}/kailian/KlSellerProduct/focus.do?modid=${f.id}&tostatus=0&pid=${param.pid}&iframe=iframe">隐藏</a>
                	</c:when>
                	<c:otherwise>
                		 <a href="${ctx}/kailian/KlSellerProduct/focus.do?modid=${f.id}&tostatus=1&pid=${param.pid}&iframe=iframe">显示</a>
                	</c:otherwise>
                </c:choose>
               
                <a href="${ctx}/kailian/KlSellerProduct/focus.do?premodid=${f.id}&pid=${param.pid}&iframe=iframe">编辑</a>
                <a href="${ctx}/kailian/KlSellerProduct/focus.do?delid=${f.id}&pid=${param.pid}&iframe=iframe">删除</a></td>
              </tr>
              </c:forEach>
              <!--
              <tr>
      ...
      <div class="focus_02">
      	<form id="form1" action="${ctx}/kailian/KlSellerProduct/focus.do?pid=${map.product.id}&iframe=iframe" method="post">
          ...
          <!--
            ...
            -->
            <li><em>图片</em>
                <div class="input1"><input id="resource" name="resource" onclick="" value="${map.photo.resource}" type="text" /></div>
