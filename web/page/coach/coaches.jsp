...
<title>教练列表${my:config('title后缀','--开练网')}</title>
...
<div class="storeBox">
       <div class="sCoach">
           <h2 class="title">教练展示</h2>
           <ul>
           <c:forEach var="c" items="${map.pg.result}">
            <li style="">
                <div class="imgDiv" style="text-align:center;"><a target="_blank" href="${ctx}/coach_${c.id}.html">
                	<img src="${ctx}/${my:smallphoto(request,c.photo,'s')}" style="max-width:216px;max-height:144px;" /></a></div>
                <h2><a target="_blank" href="sCoachShow.html">${c.name}</a></h2>
                <div class="content" >${my:maxleng(c.profile,30)}</div>
            </li>
           </c:forEach>
          <!--
            <li>
                <div class="imgDiv"><a href="sCoachShow.html"><img src="${ctx}/image/nimg216_2.jpg"/></a></div>
                <h2><a href="sCoachShow.html">李忠洋</a></h2>
                <div class="content">北京市健美比赛75公斤亚军；韦德培训体系高级教练；擅长男性增肌减脂</div>
            </li>
           -->
          </ul>
          <span class="clear_f"></span>
       </div>
                ${my:drawpage(map.pg, pageContext.request,  null)}
