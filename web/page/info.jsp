...
<!-- ${sessionurl} -->
<c:choose>
<c:when test="${(map.word eq '登录成功' or map.word eq '注册成功') and sessionScope.sessionurl ne null and sessionScope.sessionurl ne ''}">
<script>
	window.location.href = "${sessionScope.sessionurl}";  
</script>
</c:when>
<c:when test="${(map.word eq '登录成功' or map.word eq '注册成功') and param.logurl ne null and param.logurl ne ''}">
<script>
	window.location.href = "${param.logurl}"; 
</script>
</c:when>

<c:when test="${(map.word eq '登录成功' or map.word eq '注册成功') }">
<script>
