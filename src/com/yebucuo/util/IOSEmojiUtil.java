...
public class IOSEmojiUtil {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        for (int i = 0; i < ios5emoji.length; i ++) {
         System.out.println(ios5emoji[i]+"我");
         String a = ios5emoji[i]+"我";
         String b = IOSEmojiUtil.transToIOS4emoji(a);
         System.out.println(b);
        }
         System.out.println(ios4emoji);
