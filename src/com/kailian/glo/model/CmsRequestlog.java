...
public class CmsRequestlog extends BaseEntity implements java.io.Serializable {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "CmsRequestlog";
	public static final String ALIAS_ID = "id";
	public static final String ALIAS_USERID = "userid";
	public static final String ALIAS_USERNAME = "username";
	public static final String ALIAS_REQUESTURL = "requesturl";
	public static final String ALIAS_REQUESTNAME = "requestname";
	...
	public static final String ALIAS_REQTYPE = "reqtype";
	...
	public boolean equals(Object obj) {
		if(obj instanceof CmsRequestlog == false) return false;
		if(this == obj) return true;
		CmsRequestlog other = (CmsRequestlog)obj;
