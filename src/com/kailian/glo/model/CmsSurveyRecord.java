...
public class CmsSurveyRecord extends BaseEntity implements java.io.Serializable {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "CmsSurveyRecord";
	public static final String ALIAS_ID = "id";
	public static final String ALIAS_OPTION_ID = "optionId";
	public static final String ALIAS_USERWORD = "userword";
	public static final String ALIAS_SYEAR = "syear";
	public static final String ALIAS_SMONTH = "smonth";
	public static final String ALIAS_SDATE = "sdate";
	...
	public boolean equals(Object obj) {
		if(obj instanceof CmsSurveyRecord == false) return false;
		if(this == obj) return true;
		CmsSurveyRecord other = (CmsSurveyRecord)obj;
