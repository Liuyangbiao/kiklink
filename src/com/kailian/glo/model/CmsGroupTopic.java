...
public class CmsGroupTopic extends BaseEntity implements java.io.Serializable {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "CmsGroupTopic";
	...
	public static final String ALIAS_SUGGEST_COUNT = "suggestCount";
	...
	public static final String ALIAS_EXT_INT1 = "置顶";
	public static final String ALIAS_EXT_INT2 = "调查 0：无 -1 关闭 1 开启";
	public static final String ALIAS_EXT_INT3 = "总票数";
	public static final String ALIAS_EXT_INT4 = "系统推荐";
	...
	private java.lang.Integer suggestCount;
	...
	public void setSuggestCount(java.lang.Integer value) {
		this.suggestCount = value;
	}
	
	public java.lang.Integer getSuggestCount() {
	...
	public String toString() {
		return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
			...
			.append("SuggestCount",getSuggestCount())
	...
	public boolean equals(Object obj) {
		if(obj instanceof CmsGroupTopic == false) return false;
		if(this == obj) return true;
		CmsGroupTopic other = (CmsGroupTopic)obj;
