...
public class CmsBiaodan extends BaseEntity implements java.io.Serializable {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "CmsBiaodan";
	public static final String ALIAS_ID = "id";
	public static final String ALIAS_LISTNAME = "listname";
	public static final String ALIAS_LISTKEY = "listkey";
	public static final String ALIAS_LOADONSTARTUP = "loadonstartup";
	public static final String ALIAS_DECLARATION = "declaration";
	...
	public boolean equals(Object obj) {
		if(obj instanceof CmsBiaodan == false) return false;
		if(this == obj) return true;
		CmsBiaodan other = (CmsBiaodan)obj;
