...
public class CmsGroupRight extends BaseEntity implements java.io.Serializable {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "CmsGroupRight";
	public static final String ALIAS_ID = "id";
	public static final String ALIAS_GROUP_ID = "groupId";
	public static final String ALIAS_RIGHT_ID = "rightId";
	public static final String ALIAS_GROUP_NAME = "groupName";
	public static final String ALIAS_RIGHT_NAME = "rightName";
	...
	public boolean equals(Object obj) {
		if(obj instanceof CmsGroupRight == false) return false;
		if(this == obj) return true;
		CmsGroupRight other = (CmsGroupRight)obj;
