...
public class CmsGroupUser extends BaseEntity implements java.io.Serializable {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "CmsGroupUser";
	public static final String ALIAS_ID = "id";
	public static final String ALIAS_GROUPID = "groupid";
	public static final String ALIAS_GROUPNAME = "groupname";
	public static final String ALIAS_GROUPPHOTO = "groupphoto";
	public static final String ALIAS_USERID = "userid";
	public static final String ALIAS_USERNAME = "username";
	public static final String ALIAS_PHOTO = "photo";
	public static final String ALIAS_USERLEVEL = "userlevel";
	...
	@Length(max=100)
	private java.lang.String groupphoto;
	...
	public void setGroupphoto(java.lang.String value) {
	...
	public String toString() {
		return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
			...
			.append("Groupphoto",getGroupphoto())
	...
	public boolean equals(Object obj) {
		if(obj instanceof CmsGroupUser == false) return false;
		if(this == obj) return true;
		CmsGroupUser other = (CmsGroupUser)obj;
