...
public class CmsStRhpotherdetail extends BaseEntity implements java.io.Serializable {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "CmsStRhpotherdetail";
	public static final String ALIAS_ID = "id";
	public static final String ALIAS_PID = "pid";
	public static final String ALIAS_PNAME = "名称";
	public static final String ALIAS_LOGOIMG = "图片 320*260";
	public static final String ALIAS_URL = "链接地址";
	public static final String ALIAS_COACHNAME = "特约教练";
	...
	public boolean equals(Object obj) {
		if(obj instanceof CmsStRhpotherdetail == false) return false;
		if(this == obj) return true;
		CmsStRhpotherdetail other = (CmsStRhpotherdetail)obj;
