...
public class KlSellerPlace extends BaseEntity implements java.io.Serializable {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "KlSellerPlace";
	public static final String ALIAS_ID = "id";
	public static final String ALIAS_SHOP_ID = "shopId";
	public static final String ALIAS_PLACE_COMMENT = "placeComment";
	...
	public String toString() {
		return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
			...
			.append("PlaceComment",getPlaceComment())
	...
	public boolean equals(Object obj) {
		if(obj instanceof KlSellerPlace == false) return false;
		if(this == obj) return true;
		KlSellerPlace other = (KlSellerPlace)obj;
