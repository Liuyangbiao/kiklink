...
import com.kailian.glo.dao.ICmsAdminuserDao;
...
@Repository("cmsAdminuserDao")
public class CmsAdminuserDaoImpl extends BaseIbatisDao<CmsAdminuser,java.lang.Long> implements ICmsAdminuserDao{
...
//		}
	...
	public List<CmsAdminuser> findAll(){
		...
		return this.queryforList("CmsAdminuser.findTop", map);
	}
...
//		}
	...
	public Page findPage(CmsAdminuserQuery query) {
		return pageQuery("CmsAdminuser.findPage",query);
	}
	
	
	
	public List<CmsAdminuser> queryTop(int count, String sortBy) {
	...
	public List<CmsAdminuser> queryforList(String sqlName,Map paraMap) {
	...
	public long queryCount(CmsAdminuserQuery query) {
		Map map = Utils.transBean2Map(query);
		Long l = (Long) this.getSqlMapClientTemplate().queryForObject("CmsAdminuser.findPage.count", map);
		return l;
	}
	
	public void updateGroupUserCount(long groupid) {
		Map map = new HashMap();
		map.put("groupid", groupid);
		this.getSqlMapClientTemplate().update("CmsAdminuser.updatecount", map);
	}
}
