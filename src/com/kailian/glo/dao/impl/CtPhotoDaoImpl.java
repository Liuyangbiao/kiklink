...
import com.kailian.glo.dao.ICtPhotoDao;
...
@Repository("ctPhotoDao")
public class CtPhotoDaoImpl extends BaseIbatisDao<CtPhoto,java.lang.Long> implements ICtPhotoDao{
...
//		}
	...
	public List<CtPhoto> findAll(){
		...
		return this.queryforList("CtPhoto.findTop", map);
	}
...
//		}
	...
	public Page findPage(CtPhotoQuery query) {
		return pageQuery("CtPhoto.findPage",query);
	}
	...
	public long queryCount(CtPhotoQuery query) {
		Map map = Utils.transBean2Map(query);
		Long l = (Long) this.getSqlMapClientTemplate().queryForObject("CtPhoto.findPage.count", map);
		return l;
	}
