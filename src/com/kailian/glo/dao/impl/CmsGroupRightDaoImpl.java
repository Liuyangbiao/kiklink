...
import com.kailian.glo.dao.ICmsGroupRightDao;
...
@Repository("cmsGroupRightDao")
public class CmsGroupRightDaoImpl extends BaseIbatisDao<CmsGroupRight,java.lang.Long> implements ICmsGroupRightDao{
...
//		}
	...
	public List<CmsGroupRight> findAll(){
		...
		return this.queryforList("CmsGroupRight.findTop", map);
	}
...
//		}
	...
	public Page findPage(CmsGroupRightQuery query) {
		return pageQuery("CmsGroupRight.findPage",query);
	}
	
	
	
	public List<CmsGroupRight> queryTop(int count, String sortBy) {
	...
	public List<CmsGroupRight> queryforList(String sqlName,Map paraMap) {
	...
	public long queryCount(CmsGroupRightQuery query) {
		Map map = Utils.transBean2Map(query);
		Long l = (Long) this.getSqlMapClientTemplate().queryForObject("CmsGroupRight.findPage.count", map);
		return l;
	}
