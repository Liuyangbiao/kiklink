...
import com.kailian.glo.dao.ICmsCommonSavedDao;
...
@Repository("cmsCommonSavedDao")
public class CmsCommonSavedDaoImpl extends BaseIbatisDao<CmsCommonSaved,java.lang.Long> implements ICmsCommonSavedDao{
...
//		}
	...
	public List<CmsCommonSaved> findAll(){
		...
		return this.queryforList("CmsCommonSaved.findTop", map);
	}
...
//		}
	...
	public Page findPage(CmsCommonSavedQuery query) {
		return pageQuery("CmsCommonSaved.findPage",query);
	}
	...
	public long queryCount(CmsCommonSavedQuery query) {
		Map map = Utils.transBean2Map(query);
		Long l = (Long) this.getSqlMapClientTemplate().queryForObject("CmsCommonSaved.findPage.count", map);
		return l;
	}
