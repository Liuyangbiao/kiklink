...
import com.kailian.glo.dao.ICtUserCityDao;
...
@Repository("ctUserCityDao")
public class CtUserCityDaoImpl extends BaseIbatisDao<CtUserCity,java.lang.Long> implements ICtUserCityDao{
...
//		}
	...
	public List<CtUserCity> findAll(){
		...
		return this.queryforList("CtUserCity.findTop", map);
	}
...
//		}
	...
	public Page findPage(CtUserCityQuery query) {
		return pageQuery("CtUserCity.findPage",query);
	}
	
	
	
	public List<CtUserCity> queryTop(int count, String sortBy) {
	...
	public List<CtUserCity> queryforList(String sqlName,Map paraMap) {
	...
	public long queryCount(CtUserCityQuery query) {
		Map map = Utils.transBean2Map(query);
		Long l = (Long) this.getSqlMapClientTemplate().queryForObject("CtUserCity.findPage.count", map);
		return l;
	}
