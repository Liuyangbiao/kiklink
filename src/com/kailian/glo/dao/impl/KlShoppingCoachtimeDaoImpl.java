...
import com.kailian.glo.dao.IKlShoppingCoachtimeDao;
...
@Repository("klShoppingCoachtimeDao")
public class KlShoppingCoachtimeDaoImpl extends BaseIbatisDao<KlShoppingCoachtime,java.lang.Long> implements IKlShoppingCoachtimeDao{
...
//		}
	...
	public List<KlShoppingCoachtime> findAll(){
		...
		return this.queryforList("KlShoppingCoachtime.findTop", map);
	}
...
//		}
	...
	public Page findPage(KlShoppingCoachtimeQuery query) {
		return pageQuery("KlShoppingCoachtime.findPage",query);
	}
	...
	public long queryCount(KlShoppingCoachtimeQuery query) {
		Map map = Utils.transBean2Map(query);
		Long l = (Long) this.getSqlMapClientTemplate().queryForObject("KlShoppingCoachtime.findPage.count", map);
		return l;
	}
