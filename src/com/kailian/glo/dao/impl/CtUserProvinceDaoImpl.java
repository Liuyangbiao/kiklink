...
import com.kailian.glo.dao.ICtUserProvinceDao;
...
@Repository("ctUserProvinceDao")
public class CtUserProvinceDaoImpl extends BaseIbatisDao<CtUserProvince,java.lang.Long> implements ICtUserProvinceDao{
...
//		}
	...
	public List<CtUserProvince> findAll(){
		...
		return this.queryforList("CtUserProvince.findTop", map);
	}
...
//		}
	...
	public Page findPage(CtUserProvinceQuery query) {
		return pageQuery("CtUserProvince.findPage",query);
	}
	
	
	
	public List<CtUserProvince> queryTop(int count, String sortBy) {
	...
	public List<CtUserProvince> queryforList(String sqlName,Map paraMap) {
	...
	public long queryCount(CtUserProvinceQuery query) {
		Map map = Utils.transBean2Map(query);
		Long l = (Long) this.getSqlMapClientTemplate().queryForObject("CtUserProvince.findPage.count", map);
		return l;
	}
