...
import com.kailian.glo.dao.ICmsArticleDao;
...
public class CmsArticleDaoImpl extends BaseIbatisDao<CmsArticle,java.lang.Long> implements ICmsArticleDao{
...
//		}
	...
	public List<CmsArticle> findAll(){
		...
		return this.queryforList("CmsArticle.findTop", map);
	}
...
//		}
	...
	public Page findPage(CmsArticleQuery query) {
		return pageQuery("CmsArticle.findPage",query);
	}
	...
	public long queryCount(CmsArticleQuery query) {
		Map map = Utils.transBean2Map(query);
		Long l = (Long) this.getSqlMapClientTemplate().queryForObject("CmsArticle.findPage.count", map);
		return l;
	}
