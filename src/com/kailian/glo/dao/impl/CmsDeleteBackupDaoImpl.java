...
@Repository("cmsDeleteBackupDao")
public class CmsDeleteBackupDaoImpl extends BaseIbatisDao<CmsDeleteBackup,java.lang.Long> implements ICmsDeleteBackupDao{
...
//		}
	...
	public List<CmsDeleteBackup> findAll(){
		...
		return this.queryforList("CmsDeleteBackup.findTop", map);
	}
...
//		}
	...
	public Page findPage(CmsDeleteBackupQuery query) {
		return pageQuery("CmsDeleteBackup.findPage",query);
	}
	
	
	
	public List<CmsDeleteBackup> queryTop(int count, String sortBy) {
	...
	public List<CmsDeleteBackup> queryforList(String sqlName,Map paraMap) {
	...
	public long queryCount(CmsDeleteBackupQuery query) {
		Map map = Utils.transBean2Map(query);
		Long l = (Long) this.getSqlMapClientTemplate().queryForObject("CmsDeleteBackup.findPage.count", map);
		return l;
	}
