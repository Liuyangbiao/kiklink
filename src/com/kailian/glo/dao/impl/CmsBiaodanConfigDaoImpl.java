...
import com.kailian.glo.dao.ICmsBiaodanConfigDao;
...
@Repository("cmsBiaodanConfigDao")
public class CmsBiaodanConfigDaoImpl extends BaseIbatisDao<CmsBiaodanConfig,java.lang.Long> implements ICmsBiaodanConfigDao{
...
//		}
	...
	public List<CmsBiaodanConfig> findAll(){
		...
		return this.queryforList("CmsBiaodanConfig.findTop", map);
	}
...
//		}
	...
	public Page findPage(CmsBiaodanConfigQuery query) {
		return pageQuery("CmsBiaodanConfig.findPage",query);
	}
	...
	public long queryCount(CmsBiaodanConfigQuery query) {
		Map map = Utils.transBean2Map(query);
		Long l = (Long) this.getSqlMapClientTemplate().queryForObject("CmsBiaodanConfig.findPage.count", map);
		return l;
	}
