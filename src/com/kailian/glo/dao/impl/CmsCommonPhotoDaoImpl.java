...
import com.kailian.glo.dao.ICmsCommonPhotoDao;
...
@Repository("cmsCommonPhotoDao")
public class CmsCommonPhotoDaoImpl extends BaseIbatisDao<CmsCommonPhoto,java.lang.Long> implements ICmsCommonPhotoDao{
...
//		}
	...
	public List<CmsCommonPhoto> findAll(){
		...
		return this.queryforList("CmsCommonPhoto.findTop", map);
	}
...
//		}
	...
	public Page findPage(CmsCommonPhotoQuery query) {
		return pageQuery("CmsCommonPhoto.findPage",query);
	}
	...
	public long queryCount(CmsCommonPhotoQuery query) {
		Map map = Utils.transBean2Map(query);
		Long l = (Long) this.getSqlMapClientTemplate().queryForObject("CmsCommonPhoto.findPage.count", map);
		return l;
	}
