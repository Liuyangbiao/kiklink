...
import com.kailian.glo.dao.ICmsBiaodanDao;
...
@Repository("cmsBiaodanDao")
public class CmsBiaodanDaoImpl extends BaseIbatisDao<CmsBiaodan,java.lang.Long> implements ICmsBiaodanDao{
...
//		}
	...
	public List<CmsBiaodan> findAll(){
		...
		return this.queryforList("CmsBiaodan.findTop", map);
	}
...
//		}
	...
	public Page findPage(CmsBiaodanQuery query) {
		return pageQuery("CmsBiaodan.findPage",query);
	}
	...
	public long queryCount(CmsBiaodanQuery query) {
		Map map = Utils.transBean2Map(query);
		Long l = (Long) this.getSqlMapClientTemplate().queryForObject("CmsBiaodan.findPage.count", map);
		return l;
	}
