...
import com.kailian.glo.dao.IKlSellerCardDao;
...
@Repository("klSellerCardDao")
public class KlSellerCardDaoImpl extends BaseIbatisDao<KlSellerCard,java.lang.Long> implements IKlSellerCardDao{
...
//		}
	...
	public List<KlSellerCard> findAll(){
		...
		return this.queryforList("KlSellerCard.findTop", map);
	}
...
//		}
	...
	public Page findPage(KlSellerCardQuery query) {
		return pageQuery("KlSellerCard.findPage",query);
	}
	...
	public long queryCount(KlSellerCardQuery query) {
		Map map = Utils.transBean2Map(query);
		Long l = (Long) this.getSqlMapClientTemplate().queryForObject("KlSellerCard.findPage.count", map);
		return l;
	}
